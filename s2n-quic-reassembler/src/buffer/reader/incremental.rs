...
/// Implements an incremental [`Reader`] that joins to temporary [`Storage`] as
/// the stream data
///
/// This is useful for scenarios where the stream isn't completely buffered in
/// memory and data come in gradually.
...
impl Incremental {
    ...
    pub fn with_storage<'a, C: Storage>(
        &'a mut self, storage: &'a mut C, is_fin: bool,
